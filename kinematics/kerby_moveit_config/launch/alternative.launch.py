# not working properly (unable to plan and execute paths)
import os
import yaml
...
def generate_launch_description():
    ...
    db_arg = DeclareLaunchArgument(     # not sure if I need this
    ...
    # Static TF
    static_tf = Node(       # not sure if I need this
        package="tf2_ros",
    ...
    # Load controllers
    load_controllers = []
    for controller in ["kerby_arm_moveit_controller", "kerby_base_moveit_controller", "joint_state_broadcaster"]:
        load_controllers += [
            ExecuteProcess(
