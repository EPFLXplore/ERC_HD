...
class GamePadConfig:
    ...
    def __init__(self, **kwargs):
        ...
        self.event_signals : Dict[int, List[Callable]] = {k: [] for k in GamePadConfig.INPUTS}
...
class ControlStation(Node):
    ...
    def create_bindings(self):
        ...
        self.gamepad_config.bind(GamePadConfig.L2, self.set_man_inv_axis, "value", coordinate=0, multiplier=1)
        self.gamepad_config.bind(GamePadConfig.R2, self.set_man_inv_axis, "value", coordinate=0, multiplier=-1)
        self.gamepad_config.bind(GamePadConfig.RH, self.set_man_inv_axis, "value", coordinate=1, multiplier=1)
        self.gamepad_config.bind(GamePadConfig.RV, self.set_man_inv_axis, "value", coordinate=2, multiplier=-1)
        
        self.gamepad_config.bind(GamePadConfig.L1, self.set_man_inv_angular, "value", coordinate=0, multiplier=1)
        self.gamepad_config.bind(GamePadConfig.R1, self.set_man_inv_angular, "value", coordinate=0, multiplier=-1)
        self.gamepad_config.bind(GamePadConfig.LV, self.set_man_inv_angular, "value", coordinate=1, multiplier=-1)
        self.gamepad_config.bind(GamePadConfig.LH, self.set_man_inv_angular, "value", coordinate=2, multiplier=-1)
