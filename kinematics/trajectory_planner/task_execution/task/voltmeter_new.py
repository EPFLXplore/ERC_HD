...
class VoltmeterAlignNew(ToolPickup):
    ...
    def constructCommandChain(self):
        ...
        self.constructStandardDetectionCommands("voltmeter", extended=extended, add_objects=True)
        ...
        #     pre_operation = lambda cmd: (cmd.setDistance(self.press_distance),
        #                                  cmd.setAxisFromOrientation(self.object_pose.orientation)),
