...
#define EC_TIMEOUTSTATE    5000 // have to be inf at 100ms
...
enum
{
   ECT_SII_MANUF       = 0x0008,    /*Vendor Id*/
   ECT_SII_ID          = 0x000a,    /*Produc Code*/
   ECT_SII_REV         = 0x000c,    /*Revision Number*/
   ECT_SII_BOOTRXMBX   = 0x0014,    /*Bootstrap Receive Mailbox offset*/
   ECT_SII_BOOTTXMBX   = 0x0016,    /*Bootstrap Send Mailbox offset*/
   ECT_SII_RXMBXADR    = 0x0018,    /*Standard Receive Mailbox offset*/
   ECT_SII_MBXSIZE     = 0x0019,    /*Standard Receive Mailbox size*/
   ECT_SII_TXMBXADR    = 0x001a,    /*Standard Send Mailbox offset*/
/* ECT_SII_TXMBXSIZE   = 0x001b,    Standard Send Mailbox size*/
   ECT_SII_MBXPROTO    = 0x001c     /*Mailbox Protocol*/
};
