...
def detected_objects_pose_callback(msg):
    ...
    for obj in msg.detected_objects:
        ...
        pose.object_pose.orientation.w = obj.x_quaternion
        pose.object_pose.orientation.x = obj.z_quaternion
        pose.object_pose.orientation.y = -obj.w_quaternion
        pose.object_pose.orientation.z = obj.y_quaternion
