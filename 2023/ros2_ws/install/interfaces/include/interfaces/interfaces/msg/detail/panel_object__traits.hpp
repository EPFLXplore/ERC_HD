...
inline std::string to_yaml(const PanelObject & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const interfaces::msg::PanelObject & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const interfaces::msg::PanelObject & msg)
{
