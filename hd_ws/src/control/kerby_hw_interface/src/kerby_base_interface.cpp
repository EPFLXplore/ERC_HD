...
hardware_interface::return_type KerbyBaseInterface::configure(const hardware_interface::HardwareInfo &hardware_info) {
...
hardware_interface::return_type KerbyBaseInterface::start() {
...
hardware_interface::return_type KerbyBaseInterface::stop() {
    return hardware_interface::return_type::OK;
}
...
hardware_interface::return_type KerbyBaseInterface::read() {
...
hardware_interface::return_type KerbyBaseInterface::write() {
