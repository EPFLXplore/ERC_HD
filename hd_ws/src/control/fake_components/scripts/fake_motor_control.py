...
class FakeMotorControl(Node):
    def __init__(self):
        ...
        self.cmd_velocities = [0.0]*MOTOR_COUNT
    ...
    def init_state(self):
        self.state.position = [0.0]*MOTOR_COUNT
        self.state.velocity = [0.0]*MOTOR_COUNT
        self.state.effort = [0.0]*MOTOR_COUNT
    ...
    def vel_cmd_callback(self, msg: Float64MultiArray):
        self.state.cmd_velocities = msg.data
