...
int main(int argc, char** argv)
{
  ...
  static const std::string PLANNING_GROUP = "astra_arm_group";
...
//   std::cout << std::endl << move_group.getEndEffectorLink() << std::endl;
//   std::cout << "orientation x : " << target_pose1.orientation.x << std::endl;
//   std::cout << "orientation y : " << target_pose1.orientation.y << std::endl;
//   std::cout << "orientation z : " << target_pose1.orientation.z << std::endl;
//   std::cout << "orientation w : " << target_pose1.orientation.w << std::endl;
//   std::cout << "position x : " << target_pose1.position.x << std::endl;
//   std::cout << "position y : " << target_pose1.position.y << std::endl;
//   std::cout << "position z : " << target_pose1.position.z << std::endl;
  geometry_msgs::msg::Pose target_pose1;
  target_pose1.orientation.w = 0.707107;
  target_pose1.orientation.y = 0.707107;
  target_pose1.orientation.x =  0;
  target_pose1.orientation.z = 0;
  target_pose1.position.x = 0.816775 + 0.15;
  target_pose1.position.y = 0.00475;
  target_pose1.position.z = 0.632125;
  //move_group.setEndEffectorLink("gripper_base");
