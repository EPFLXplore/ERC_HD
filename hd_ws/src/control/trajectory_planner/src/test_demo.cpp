...
int main(int argc, char** argv)
{
  ...
  moveit_visual_tools::MoveItVisualTools visual_tools(move_group_node, "base_link", "test_demo",
  ...
  touch_links.push_back("gripper_right_finger");
  touch_links.push_back("gripper_left_finger");
  move_group.attachObject(object_to_attach.id, "kerby_gripper_group", touch_links);
