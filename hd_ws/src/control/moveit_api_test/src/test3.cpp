...
int main(int argc, char** argv)
{
  ...
  rviz_visual_tools::RvizVisualTools visual_tools("base_link", "moveit_api_test2", node);
  ...
  attached_object.touch_links = std::vector<std::string>{ "gripper_base", "gripper_left_finger", "gripper_right_finger" };
