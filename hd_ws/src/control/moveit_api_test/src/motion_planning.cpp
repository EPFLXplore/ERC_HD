...
int main(int argc, char** argv)
{
  ...
  // for us to use.
  const std::string PLANNING_GROUP = "astra_arm_group";
  ...
  moveit_msgs::msg::Constraints pose_goal =
      kinematic_constraints::constructGoalConstraints("gripper_base", pose, tolerance_pose, tolerance_angle);
