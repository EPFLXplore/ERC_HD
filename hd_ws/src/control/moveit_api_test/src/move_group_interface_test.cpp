...
int main(int argc, char** argv)
{
  ...
  std::cout << "AAAAAAAAAAAAAA3" << std::endl;
  ...
  touch_links.push_back("astra_right_finger");
  touch_links.push_back("astra_left_finger");
  move_group.attachObject(object_to_attach.id, "astra_gripper_group", touch_links);
