...
bool astra_interfaces__msg__object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("astra_interfaces.msg._object.Object", full_classname_dest, 35) == 0);
  }
  astra_interfaces__msg__Object * ros_message = _ros_message;
  {  // type
  ...
  {  // dims
    ...
    if (!std_msgs__msg__float32_multi_array__convert_from_py(field, &ros_message->dims)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * astra_interfaces__msg__object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("astra_interfaces.msg._object");
  ...
  {  // dims
    PyObject * field = NULL;
    field = std_msgs__msg__float32_multi_array__convert_to_py(&ros_message->dims);
    if (!field) {
      return NULL;
    }
    {
