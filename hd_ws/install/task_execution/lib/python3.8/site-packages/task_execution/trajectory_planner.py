...
class Planner:
    ...
    def __init__(self):
        ...
        # publishers ===================================================================================================
        self.end_of_mvt_pub = rospy.Publisher("/arm_control/end_of_movement", astra_interfaces.msg.cmdOutcome, queue_size=5)  # TODO: probably remove this
        ...
        rospy.Subscriber("/arm_control/add_object", astra_interfaces.msg.Object, self.add_object_callback)
    ...
    def send_feedback(self, cmd_id, success):
        ...
        """
        outcome = astra_interfaces.msg.cmdOutcome()
        outcome.id = cmd_id
