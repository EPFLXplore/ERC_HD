...
#include "astra_interfaces/msg/detail/task__rosidl_typesupport_fastrtps_c.h"
...
using _Task__ros_msg_type = astra_interfaces__msg__Task;
...
size_t get_serialized_size_astra_interfaces__msg__Task(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Task__ros_msg_type * ros_message = static_cast<const _Task__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Task__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_astra_interfaces__msg__Task(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_astra_interfaces
size_t max_serialized_size_astra_interfaces__msg__Task(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Task__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_astra_interfaces__msg__Task(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, astra_interfaces, msg, Task)() {
