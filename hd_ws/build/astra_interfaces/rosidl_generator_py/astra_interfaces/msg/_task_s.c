...
bool astra_interfaces__msg__task__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("astra_interfaces.msg._task.Task", full_classname_dest, 31) == 0);
  }
  astra_interfaces__msg__Task * ros_message = _ros_message;
  {  // description
...
PyObject * astra_interfaces__msg__task__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("astra_interfaces.msg._task");
