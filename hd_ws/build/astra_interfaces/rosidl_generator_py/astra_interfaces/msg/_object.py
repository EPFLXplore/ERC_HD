...
class Object(metaclass=Metaclass_Object):
    ...
    _fields_and_field_types = {
        ...
        'dims': 'std_msgs/Float32MultiArray',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import Float32MultiArray
        self.dims = kwargs.get('dims', Float32MultiArray())
    ...
    def dims(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'dims' field must be a sub message of type 'Float32MultiArray'"
        self._dims = value
