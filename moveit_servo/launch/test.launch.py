...
def generate_launch_description():
    moveit_config = (
        ...
        .robot_description_semantic(file_path="config/kerby.srdf")
        .robot_description_kinematics(file_path="config/kinematics.yaml")
        .to_moveit_configs()
    )
    
    # Get parameters for the Servo node
    servo_yaml = load_yaml("kerby_moveit_config", "config/kerby_simulated_config.yaml")
    ...
    kerby_arm_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["kerby_arm_moveit_controller", "-c", "/controller_manager"],
    )
    ...
    # print()
    servo_node = Node(
        package="moveit_servo",   # moveit_servo
